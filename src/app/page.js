  ...
  return (
      ...
      <div className="overflow-x-hidden relative w-full">
        ...
        <nav className="bg-deepBlue">
          <div className="relative w-[1080px] mx-auto flex items-center justify-end ">

            {/* Logo */}
            <a href="/" className="cursor-pointer py-7 pr-7">
              <Image className='cursor-pointer py-7 pr-7'
                     src="/logo.png"
                     width={125}
                     height={30}
                     alt="Inventory"/></a>
            ...
            transition-all duration-200"></div>
              ...
              {/* Language Switch and Login/Sign Up Buttons */}
              <div className="flex space-x-6">

                <button className="px-5 font-mullish text-white border-lightBlue border
                rounded-sm text-sm font-bold items-center h-10 cursor-pointer self-center">Log in
                </button>
                <button className="py-3 px-4 font-mullish rounded-sm text-sm font-bold
                bg-white text-lightBlue300 cursor-pointer border transition-all duration-200
                hover:text-lightBlue500 hidden lg:flex items-center h-10 self-center ">
                  Sign Up
                  <svg viewBox="0 0 24 24" focusable="false" className="w-4 h-4 ml-3">
        ...
        <div className='bg-deepBlue'>
          ...
          <section className="relative bg-deepBlue py-28 pr-20">
            <div className="w-10/112 max-w-[1080px] flex sm:flex-col lg:flex-row justify-between items-center mx-auto">
              {/* Left part */}
              <div className="space-y-8">
                <h1 className="font-mullish font-bold text-[40px] leading-[1.2] text-white">
                  ...
                  <h3 className='text-lightBlue300'>Your Inventory, Your Way</h3>

                </h1>
                <div className="w-6 h-1 bg-greenLight"></div>
                <p className="font-mullish text-[18px] leading-7 text-white opacity-70">
                  Your tailored solution for efficient inventory management in a fast-paced business world. Streamline your resource tracking, your way.
                </p>
                <button className="bg-lightBlue text-white
          py-[14px] px-[18px] rounded-md font-mullish font-bold hover:bg-lightBlue500 transition-all duration-200">
                  Sign Up Now
                </button>
              </div>
              {/* Right part */}
              <Image className='w-full max-w-[680px] pl-15'
                     src="/pic1.png"
                     width={700}
                     height={700}
                     alt="Inventory"/>
        ...
        <section className="relative mt-28 overflow-hidden">
          ...
          <div className="relative w-11/12 max-w-[1080px] mx-auto pt-4">
            ...
            <h2 className="font-mullish text-center text-2xl leading-[1.2] font-extrabold hidden md:block">
              Track All Your Inventory At One Place
            </h2>
            <h2  className="font-mullish text-center text-1xl mt-3 leading-[1.2] font-extrabold hidden md:block">Stay on top of Management operations
            </h2>

            <div class="w-7 h-1 bg-greenLight mx-auto mt-4 mb-6"></div>


            <div className="w-full min-h-[520px] flex rounded-md relative p-10 py-12 border">
              {/* Left section */}
              <div className="flex flex-col justify-between w-full">
                <h3 className="font-mullish text-[28px] leading-10 font-bold max-w-[500px]">
                  <span className="text-lightBlue">Unlock Insights, Drive Excellence </span>
                  Empowering Data{' '}
                </h3>
                ...
                <ul class="space-y-2">
                  <li className="font-mullish flex items-center space-x-2">
                    ...
                    <span>{"Efficiently Manage Sales Orders"}</span>
                  </li>

                  <li className="font-mullish flex items-center space-x-2">
                    <i data-feather="check" className="text-greenLight"></i>
                    <span>{"Organise Orders According To Projects"}</span>
                  </li>

                  <li className="font-mullish flex items-center space-x-2">
                    <i data-feather="check" className="text-greenLight"></i>
                    <span>{"Stock Control & Adjustments"}</span>
                  </li>

                  <li className="font-mullish flex items-center space-x-2">
                    <i data-feather="check" className="text-greenLight"></i>
                    <span>{"Support Multiple Currencies"}</span>
                  </li>
                ...
                <Image className='max-w-[600px] absolute right-0 bottom-0 hidden md:max-w-[400px] lg:max-w-[600px] md:block lg:block '
                       src="/pic2.png"
                       width={500}
                       height={700}
                       alt="Inventory"/>
    ...
    3 rd section  */}
        ...
        <section>
          ...
          <div class="w-10/12 max-w-[1080px]  mx-auto relative pt-4 ">
            ...
            <h2 class="font-mullish text-center text-2xl leading-[1.2] text-white font-bold mt-10">Sailent Features Of TrakKitt</h2>
          ...
          <div class="relative w-11/12 max-w-[1080px] mx-auto pt-4">
            ...
            <Image  className="absolute w-[233px] -left-[11.5rem] -top-[6rem] z-10 flex justify-center bottom-12"
                    src="/feature-section1-dottedrows.png"
                    width={233}
                    height={700}
                    alt="Inventory"/>

            <Image  className="absolute w-[233px] -right-[11.5rem] -top-[6rem] z-10 "
                    src="/feature-section1-dottedrows.png"
                    width={233}
                    height={700}
                    alt="Inventory"/>
          ...
          <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 gap-x-4 relative z-[100]">
            ...
            <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] ml-5 w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl" >
              ...
              <h3 className="font-mullish text-lg font-bold pt-4 text-black">Email Alerts</h3>
              <p className="font-mullish py-3 text-grayText leading-normal">
                Receive timely email notifications for low or empty stock levels, ensuring stock replenishment.
              </p>
              <div className="flex flex-row items-center cursor-pointer group">
                <a href="" className="font-mullish font-bold text-lightBlue500 group-hover:text-lightBlue transition-all duration-200">
                  Know More
                </a>
                <i
            ...
            <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
              ...
              <h3 className="font-mullish text-lg font-bold pt-4 text-black">QR Code Scanner:</h3>
              <p className="font-mullish py-3 text-grayText leading-normal">
                Effortlessly preview stock details using a QR code scanner, enhancing stock management efficiency.
              </p>
              <div className="flex flex-row items-center cursor-pointer group">
                <a href="" className="font-mullish font-bold text-lightBlue500 group-hover:text-lightBlue transition-all duration-200">
                  Know More
            ...
            <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
              <Image className="w-10 h-10"
                     ...
                     height={10}
                     alt="Inventory"/>
              <h3 className="font-mullish text-lg font-bold pt-4 text-black">Admin Management:</h3>
              <p className="font-mullish py-3 text-grayText leading-normal">
                Efficiently add and manage users with administrative privileges, ensuring smooth system control.
              </p>
              <div className="flex flex-row items-center cursor-pointer group">
                <a href="" className="font-mullish font-bold text-lightBlue500 group-hover:text-lightBlue transition-all duration-200">
                  Know More
            ...
            <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] ml-5 w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl" >
              <Image className="w-10 h-10"
                     ...
                     height={10}
                     alt="Inventory"/>
              <h3 className="font-mullish text-lg font-bold pt-4 text-black">User Management:</h3>
              <p className="font-mullish py-3 text-grayText leading-normal">
                Empower users to manage and track stocks, enhancing the stock management process.
                .
              </p>
              <div className="flex flex-row items-center cursor-pointer group">
                <a href="" className="font-mullish font-bold text-lightBlue500 group-hover:text-lightBlue transition-all duration-200">
    ...
    item 5 */}
            ...
            <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
              <Image className="w-10 h-10"
                     ...
                     height={10}
                     alt="Inventory"/>
              <h3 className="font-mullish text-lg font-bold pt-4 text-black">Interactive Dashboard</h3>
              <p className="font-mullish py-3 text-grayText leading-normal">
                Utilize an interactive dashboard for a comprehensive visualization of reports and analytics, aiding in data-driven decision-making
              </p>
              <div className="flex flex-row items-center cursor-pointer group">
                <a href="" className="font-mullish font-bold text-lightBlue500 group-hover:text-lightBlue transition-all duration-200">
                  Know More
            ...
            <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
              ...
              <h3 className="font-mullish text-lg font-bold pt-4 text-black">Category Organization</h3>


              <p className="font-mullish py-3 text-grayText leading-normal">
                Categorize inventory items for a systematic and organized distribution of stock types.
              </p>
              <div className="flex flex-row items-center cursor-pointer group">
                <a href="" className="font-mullish font-bold text-lightBlue500 group-hover:text-lightBlue transition-all duration-200">
                  Know More
        ...
        {/* join Inventory section */}

        <section class="bg-[black] relative pt-40 pb-12 -mt-[200px] -z-[100]">
          ...
          <div className="w-11/12 max-w-[1080px] mx-auto relative flex flex-col md:flex-row">
            ...
            <div class="flex flex-col justify-center w-full md:max-w-[calc(100%-500px)] sm:my-16">
              <h2 class="font-mullish font-bold text-2xl text-deepBlueHead">Join the 50,00,000+ businesses using Razorpay
              </h2>
              <div class="w-6 h-1 bg-greenLight  my-4 mb-10"></div>
              <p class="font-mullish opacity-80">We make it easier for you to focus on building great products while we work
                on simplifying your payments. Become one of us by joining thousands of our happy users and simplify the
                online payment experience for your customers.</p>
              <p class="font-mullish mt-6 opacity-80">Focus on your business while we handle the complexities of payments
                for you.
              </p>
            </div>
        ...
        <section>
          ...
          <div className="w-full flex flex-row mx-auto space-x-2 justify-center mb-10">
