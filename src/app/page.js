...
export default function Home() {
  return (
    // NAVBAR
    <div className="bg-primary overflow-hidden relative w-full">
      {/* Navbar */}
      <nav
        className={`bg-primary ${styles.flexStart} w-full flex py-6 justify-between items-center px-[60px]`}
      >
        {/* Logo */}
        <a href="/" className={`font-poppins font-normal cursor-pointer text-[25px] text-white`}>
          TrackIT
        </a>
        ...
        >
          ...
          >
            ...
            <div className="flex flex-row justify-between items-center w-full">
              <h1 className="flex-1 font-poppins font-semibold ss:text-[58px] text-[32px] text-white ss:leading-[75px] leading-[50px]">
               Efficiency at Your  <br className="sm:block hidden" />{" "}
                <span className="text-gradient">Fingertips Streamline</span>{" "}
              </h1>
            </div>

            <h1 className="font-poppins font-semibold ss:text-[48px] text-[32px] text-white ss:leading-[75px] leading-[50px] w-full">
             Your Inventory.
            </h1>
            <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
              Your tailored solution for efficient inventory management in a
              fast-paced business world. Streamline your resource tracking, your
              way.
            </p>
            <Link href="/register">
            <button
              type="button"
              className={`py-4 px-6 font-poppins my-3 font-medium text-[18px] text-primary bg-blue-gradient rounded-[10px] outline-none ${styles.flexCenter}`}
            >
              Get it free
            </button>
            </Link>
      ...
      <section>
        ...
        <div class="relative w-11/12 max-w-[1080px] mx-auto pt-4">
          <Image
            className="absolute w-[233px] -left-[11.5rem] -top-[6rem] z-10 flex justify-center bottom-12"
          ...
          <Image
            className="absolute w-[233px] -right-[11.5rem] -top-[6rem] z-10 "
            src="/feature-section1-dottedrows.png"
            width={233}
            height={700}
            alt="Inventory"
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 gap-x-4 relative z-[100]">
          ...
          <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] ml-5 w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
            ...
            <h3 className="font-mullish text-lg font-bold pt-4 text-black">
              Email Alerts
            </h3>
            <p className="font-mullish py-3 text-grayText leading-normal">
              Receive timely email notifications for low or empty stock levels,
          ...
          <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
            ...
            <p className="font-mullish py-3 text-grayText leading-normal">
              Effortlessly preview stock details using a QR code scanner,
          ...
          <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
            ...
            <p className="font-mullish py-3 text-grayText leading-normal">
              Efficiently add and manage users with administrative privileges,
              ensuring smooth system control.
            </p>
            <div className="flex flex-row items-center cursor-pointer group">
              <a
                href=""
          ...
          <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] ml-5 w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
            ...
            <p className="font-mullish py-3 text-grayText leading-normal">
              Empower users to manage and track stocks, enhancing the stock
              management process. .
            </p>
            <div className="flex flex-row items-center cursor-pointer group">
              <a
    ...
    item 5 */}
          ...
          <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
            ...
            <p className="font-mullish py-3 text-grayText leading-normal">
              Utilize an interactive dashboard for a comprehensive visualization
              of reports and analytics, aiding in data-driven decision-making
            </p>
            <div className="flex flex-row items-center cursor-pointer group">
              <a
                href=""
          ...
          <div className="p-10 bg-[url(/images/instant-settlement-bg.svg)] w-[95%] max-h-[300px] cursor-pointer bg-no-repeat hover:scale-105 transition-all duration-200 hover:bg-[url(/images/instant-settlement-bghover.svg)] bg-white rounded-xl">
            ...
            <p className="font-mullish py-3 text-grayText leading-normal">
              Categorize inventory items for a systematic and organized
      ...
      <section className="bg-primary">
        <div className="bg-primary w-full flex flex-row mx-auto space-x-2 justify-center mb-10">
